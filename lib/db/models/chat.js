 ...
 */
chatSchema.statics.getChatFromDb = function (telegramChatId) {
 ...
 * @returns {Promise<Object|null>}
 */
chatSchema.statics.getChatProjectsFromDb = function (telegramChatId) {
 ...
 * @returns {Promise<Object|null>}
 */
chatSchema.statics.addProjectToChat = function (telegramChatId, project) {
 ...
 * @returns {Promise<Object|null>}
 */
chatSchema.statics.deleteProjectFromChat = function (telegramChatId, projectName) {
 ...
 * @returns {[]|string[]}
 */
chatSchema.statics.getUrlsFromChat = function (chatDocument, projectName = 'all') {
  if (chatDocument) {
    let result = [];
